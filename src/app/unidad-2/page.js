        ...
        <div className="container mx-auto px-6 py-8 flex gap-8">
            ...
            <div className="w-full">
                ...
                <nav className="flex justify-between items-center mt-8">
                    <Link href="/unidad-1" className="text-blue-600 hover:underline">‹ SECCIÓN ANTERIOR<br />Unidad I</Link>
                    <Link href="/unidad-3" className="text-blue-600 hover:underline text-right">SECCIÓN SIGUIENTE ›<br />Unidad III</Link>
                </nav>
            </div>
        </div>
    );
