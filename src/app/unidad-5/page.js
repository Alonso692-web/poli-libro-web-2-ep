...
const handlePlayVideo = () => {
    const urlVideo = 'https://youtu.be/FA6d9f_bs_Q?si=m6JwKbIsmm8otugr';
    window.open(urlVideo, '_blank', 'noopener,noreferrer');
};

export default function Unidad5Page() {
    const unit = courseData.units.find(u => u.slug === 'unidad-5');
    ...
    const breadcrumbItems = [
        ...
        { name: `Unidad V: ${unit.subtitle}`, href: `/${unit.slug}` }
    ];
        ...
        <div className="container mx-auto px-6 py-8 flex gap-8">
            ...
            <div className="w-full">
                ...
                <nav className="flex justify-between items-center mt-8">
                    <Link href="/unidad-4" className="text-blue-600 hover:underline">‹ SECCIÓN ANTERIOR<br />Unidad IV</Link>
